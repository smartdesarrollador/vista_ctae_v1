...
import { CVData, PersonalInfo, AboutSection, Experience, Education, SkillCategory, Project, Testimonial, ContactInfo, ThemeConfig } from '../models/cv-data.interface';
...
export class CvDataService {
  ...
  private mockAbout: AboutSection = {
    description: "Soy un desarrollador full stack apasionado con más de 10 años de experiencia especializado en desarrollo web moderno con Angular, Laravel y tecnologías frontend. Me enfoco en crear soluciones innovadoras y escalables que mejoren la experiencia del usuario y optimicen los procesos de negocio.",
    yearsExperience: 10,
    projectsCompleted: 65,
    clientsSatisfied: 35,
    technologies: ["Angular", "Laravel", "TypeScript", "PHP", "MySQL", "JavaScript", "HTML5", "CSS3"]
  };
  ...
  private mockExperience: Experience[] = [
    {
      ...
      endDate: undefined,
      location: "Lima, Perú",
      description: "Desarrollo de aplicaciones web enterprise usando Angular, Laravel y tecnologías modernas. Liderazgo técnico de proyectos complejos y mentoreo de desarrolladores.",
      technologies: ["Angular", "Laravel", "MySQL", "TypeScript", "PHP", "TailwindCSS", "Vue.js"],
      achievements: [
    ...
    },
    {
      ...
      endDate: "2018-10",
      location: "Lima, Perú",
      description: "Desarrollo de interfaces de usuario modernas y responsive. Especialización en JavaScript, HTML5, CSS3 y frameworks frontend.",
      technologies: ["JavaScript", "HTML5", "CSS3", "jQuery", "Bootstrap", "SASS", "Gulp"],
      achievements: [
    ...
    },
    {
      ...
      endDate: "2015-04",
      location: "Lima, Perú",
      description: "Desarrollo de aplicaciones web completas usando PHP y MySQL. Primeros pasos en el desarrollo full stack profesional.",
  ...
  private mockEducation: Education[] = [
    {
      ...
      location: "Lima, Perú",
      gpa: "15.8/20",
      description: "Formación integral en desarrollo de software, análisis de sistemas y tecnologías de la información.",
      achievements: [
    ...
    },
    {
      ...
      endDate: "2020-08",
      location: "Online",
      description: "Especialización completa en JavaScript, React, Angular y tecnologías frontend modernas."
    },
    {
      id: 3,
      ...
      endDate: "2019-09",
      location: "Lima, Perú",
      description: "Certificación oficial en desarrollo de aplicaciones web con Laravel PHP Framework."
    },
    {
      id: 4,
      ...
      endDate: "2023-03",
      location: "Online",
      description: "Certificación en implementación y gestión de soluciones en Google Cloud Platform."
    }
  ];
  ...
  private mockProjects: Project[] = [
    {
      ...
      description: "Plataforma completa de e-commerce con integración a Culqi/Niubiz, gestión de inventarios y panel administrativo avanzado.",
    ...
    },
    {
      ...
      description: "Sistema integral de gestión empresarial con módulos de facturación, inventarios, CRM y reportes analíticos en tiempo real.",
    ...
    },
    {
      ...
      description: "Aplicación web para gestión de clínicas con citas médicas, historiales clínicos, recetas digitales y reportes médicos.",
    ...
    },
    {
      ...
      description: "Sistema POS para restaurantes con gestión de mesas, comandas, facturación y control de inventario de cocina.",
  ...
  private mockTestimonials: Testimonial[] = [
    {
      ...
      testimonial: "Jeans es un desarrollador excepcional. Su capacidad técnica y creatividad han sido fundamentales para el éxito de nuestros proyectos. Siempre entrega código de alta calidad y supera las expectativas.",
      imageUrl: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face&auto=format&q=80",
      rating: 5
    },
    {
      id: 2,
      ...
      testimonial: "Trabajar con Jeans fue una experiencia increíble. Su atención al detalle y comprensión de los requisitos del negocio hacen que sea muy fácil colaborar con él. Excelente profesional.",
      imageUrl: "https://images.unsplash.com/photo-1494790108755-2616b612b08c?w=150&h=150&fit=crop&crop=face&auto=format&q=80",
      rating: 5
    },
    {
      id: 3,
      ...
      testimonial: "Jeans tiene una curva de aprendizaje impresionante. En poco tiempo dominó nuestro stack tecnológico y comenzó a contribuir significativamente al proyecto. Muy recomendado.",
    ...
    },
    {
      ...
      testimonial: "La colaboración con Jeans fue perfecta. Entiende perfectamente los diseños y los implementa con precisión. Su conocimiento en Angular y React es sobresaliente.",
      imageUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face&auto=format&q=80",
      rating: 5
    },
    {
      id: 5,
      ...
      position: "CEO",
      company: "StartupLima",
      testimonial: "Jeans desarrolló nuestra plataforma web desde cero. Su profesionalismo, puntualidad y calidad técnica superaron nuestras expectativas. Definitivamente lo recomendaríamos.",
      imageUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face&auto=format&q=80",
      rating: 5
    }
  ];
  ...
  private mockContact: ContactInfo = {
    ...
    message: "¿Tienes un proyecto interesante? ¡Me encantaría colaborar contigo y crear algo increíble juntos!",
